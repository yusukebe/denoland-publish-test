import {
  ...
  GraphQLObjectType,
  GraphQLNonNull,
} from 'https://cdn.skypack.dev/graphql@4.8.0?dts'
import { Hono } from 'https://deno.land/x/hono@v3.1.5/mod.ts'
import type { Context, Next } from 'https://deno.land/x/hono@v3.1.5/mod.ts'
import { errorMessages, graphqlServer } from '../src/index.ts'
import type { RootResolver } from '../src/index.ts'
